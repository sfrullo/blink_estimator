function process_video_parallel(video_input_folder, video_output_folder, data_output_folder)
    ...
    parfor p=1:length(files)
        ...
        % profile viewer
            ...
            % save data variable
            parsave(fullfile(data_output_folder, strrep(file.name, '.avi', '')), data);
